    ...
    return <View style={{margin: 10}}>
        <View style={{padding: 10}}>
            <Text style={{
                ...
                fontSize: 20,
                textAlign: "center"
            }}>{vocabulary['add post'][language]}</Text>
        </View>
        <View style={{marginBottom: 10, backgroundColor : firstPrimaryFont, borderRadius: 10}}>
            <TextInput style={{padding : 2}} value={postName} onChangeText={setPostName} placeholder={vocabulary['post name'][language]}/>
        </View>
        <View style={{backgroundColor: firstPrimaryFont, borderRadius: 10}}>
            <Textarea rowSpan={3} placeholder={vocabulary['post description'][language]}
                      style={{color: secondPrimaryFont}}/>
        </View>
