...
export const LogOut: FC<PropType> = ({signOut}) => {
    ...
    return <View>
        <View style={{flexDirection: 'row', justifyContent: 'center'}}>
            ...
            <Text style={{color: firstPrimaryFont, textTransform: 'uppercase', fontSize: 20}}>{vocabulary['logout'][language]}</Text>
        </View>
        <View style={{backgroundColor: 'rgba(255,255,255,0.2)'}}>
            <SettingsItem icon='md-log-out' title={vocabulary['exit'][language]} colorWord={firstPrimaryFont} colorButton={'rgba(0,0,0,0)'}
