...
const initialState: InitialStateType = {
    ...
    photos: [{
        id: '1',
        uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmT5wCnqckzkvzvgZoxSHXVOydQzi-S7xcbA&usqp=CAU'
    }, {
        id: '2',
        uri: 'https://post.medicalnewstoday.com/wp-content/uploads/sites/3/2020/02/322868_1100-800x825.jpg'
    }, {
        id: '3',
        uri: 'https://www.vettimes.co.uk/app/uploads/2020/01/close-up-photography-of-adult-black-and-white-short-coat-dog-733416.jpg'
    }],
    posts: [{
        id: '1',
    ...
    userInf: {
        ...
        name: 'some test name',
        uri: 'https://c.files.bbci.co.uk/9B8B/production/_104191893_kukurtihar_papputhedog_-pappu_the_pug_nepal.png'
    },
}
