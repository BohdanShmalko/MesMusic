...
const RegistrationForm = props => {
    ...
    return (
        <form onSubmit={props.handleSubmit}>
            {FieldCreator('Your name : ', 'name',
                CheckInput, [maxLength20, minLength3, empty],
                null, 'Name', stl.field)}

            {FieldCreator('Your last name : ', 'lastName',
                CheckInput, [maxLength20, minLength3, empty],
                null, 'Last name', stl.field)}

            {FieldCreator('Enter your email or phone number',
                'emailNumber', CheckInput, [empty],
                null, 'Email or phone number', stl.field)}

            {FieldCreator('Come up with a password : ',
                'password', CheckInput, [empty],
                'password', 'password', stl.field)}

            {FieldCreator('Repeat your password : ',
                'repeatPassword', CheckInput, [repeatPassword(props.currentPassword),
                    empty], 'password', 'repeat password', stl.field)}
